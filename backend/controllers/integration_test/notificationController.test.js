...
describe('Notification Controller Integration Tests', () => {
	...
	describe('sendPasswordCreationEmail', () => {
		...
		it('debería manejar errores de envío', async () => {
			...
			await expect(sendPasswordCreationEmail(testUser)).rejects.toThrow(
	...
	describe('sendPasswordResetEmail', () => {
		...
		it('debería manejar errores de envío', async () => {
			...
			await expect(sendPasswordResetEmail(testUser)).rejects.toThrow(
	...
	describe('Validaciones de seguridad', () => {
		...
		it('debería manejar errores en solicitudes simultáneas', async () => {
			...
			const promises = Array(2)
				.fill()
				.map(() => sendPasswordResetEmail(testUser).catch(error => error));
