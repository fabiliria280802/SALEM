...
const EfficiencyPage = () => {
	...
	const [docsMetrics, setDocsMetrics] = useState([]);
		...
		datasets: [
			{
				...
				data: Object.keys(
					filteredMetrics.reduce((fields, m) => {
						Object.keys(m.field_errors || {}).forEach(
							key => (fields[key] = true),
						);
						return fields;
					}, {}),
					...
					filteredMetrics.reduce(
						(acc, m) => acc + (m.field_errors[key] || 0),
						0,
					),
				),
			...
			<div className={styles.grid}>
				<div className={styles.card}>
					...
					<p className={styles.chartDescription}>
						Representa la precisión de las predicciones de la IA agrupadas por
						lote.
					</p>
				...
				<div className={styles.card}>
					...
					<p className={styles.chartDescription}>
						Proporción de errores falsos positivos y falsos negativos en el
						sistema.
					</p>
					<Chart
						type="bar"
				...
				<div className={styles.card}>
					...
					<p className={styles.chartDescription}>
						Variabilidad del puntaje de confianza en las predicciones
						realizadas.
					</p>
				...
				<div className={styles.card}>
					...
					<p className={styles.chartDescription}>
						Muestra los campos con mayor cantidad de errores en las
						predicciones.
					</p>
					<Chart
						type="bar"
						data={fieldErrorsData}
						options={{ indexAxis: 'y' }}
					/>
				</div>
			</div>
